...
{
    public partial class blockpair
    {
        public blockpair()
        {
            Hash1 = new HashSet<Hash>();
            Hash2 = new HashSet<Hash>();
            blockpair[] = new string[$"{Hash1},{Hash2}"];
            
        }

        public int HashHMACSHA512 { get; set; }
        ...
        public ICollection<Hash> Hash { get; set; }
    }
}
